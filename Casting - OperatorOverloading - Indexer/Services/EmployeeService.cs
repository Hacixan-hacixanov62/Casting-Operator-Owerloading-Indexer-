...
using Casting___OperatorOverloading___Indexer.Helpers.Constans;
using Casting___OperatorOverloading___Indexer.Helpers.Responses;
using Casting___OperatorOverloading___Indexer.Services.Interfaces;

namespace Casting___OperatorOverloading___Indexer.Services
{
    public class EmployeeService :IEmployeeServices 
    {
        ...
        public static EmployeeResponse GetById(Employee[] employees, int? id)
        {
            if (id == null)
            {
        ...
        public EmployeeResponse[] Search(Employee[] employees, string str)
        {
            ...
            Employee[] employee = employees.Where(m => m.Name.Contains(str) || m Name.Contains(str)).ToArray();
        ...
        EmployeeResponse IEmployeeServices.GetById(Employee[] employees, int? id)
        {
        ...
        EmployeeResponse[] IEmployeeServices.Search(Employee[] employees, string str)
        {
            throw new NotImplementedException();
        }
